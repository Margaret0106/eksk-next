      ...
      <section className="section section3">
        ...
        <div className="reviews-list">
          <Swiper
            ...
            {reviews.map((el, i) => (<ReviewSlide key={el.id} {...el}/>))}
          </Swiper>
          ...
          <div
            className={`swiper-button-prev ${this.state.isBeginning
            ? 'swiper-button-disabled'
            : ''}`}
            onClick={this.goPrev}></div>
          <div
            className={`swiper-button-next ${this.state.isEnd
            ? 'swiper-button-disabled'
            : ''}`}
            onClick={this.goNext}></div>
