  ...
  function AddKsk(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_handleSubmit", function (event) {
      ...
      fetch("http://eksk-landing.rocketfirm.net/en/api/v1/feedback/create", {
        method: 'POST',
        headers: {
          'Authorization': 'Bearer GZavaFROL7WLxUEISqQRv-9_9XHfG01N' // 'Content-Type': 'application/x-www-form-urlencoded'                   
...
//# sourceMappingURL=index.js.de0bac969dfe8fd33007.hot-update.js.map